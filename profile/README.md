![kVARon: Power Systems Technology](https://raw.githubusercontent.com/kvaron/.github/main/images/logo-hero.png)

**Tools for power systems engineering, grid visualization, and energy infrastructure.**

[kvaron.com](https://kvaron.com)
...
| Area | Details |
|------|---------|
| **Operational Viz** | Real-time dashboards, Grafana ecosystems, SCADA/EMS integration |
| **Timeseries Data** | PI/AF, openHistorian, influxDb, TimescaleDB, Prometheus |
| **Power Systems** | Load flow, OPF, contingency analysis, state estimation, market simulation |
| **Grid Security** | NERC CIP compliance, cybersecurity frameworks, DevSecOps for critical infrastructure |
| **Standards** | IEEE 2664-2024 (STTP) contributor: secure time-series data transmission |
| **Infrastructure** | Kubernetes, hardened containers, CI/CD for regulated environments |
